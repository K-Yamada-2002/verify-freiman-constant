#!/usr/bin/env python3
"""131-free endpoint-type discovery, adapted from Freiman/schecker_generalized/search_types.py.
...
from exact import matrix, state_of, step, extreme_tail, extensions


def value(q):
    return float(q.a)+float(q.b)*(10.0**0.5)
...
class Search:
    def __init__(self,menu_depth=1,ratio_bound=5):
        ...
        self.parameters=lru_cache(65536)(self._parameters)
        self.pool=lru_cache(2048)(self._pool)
