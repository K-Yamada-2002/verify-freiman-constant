...
そのために，\verb|cases|に含まれる一つの\verb|case|について，次のような計算を行う：
...
\verb|select_successor_endpoint_pairs|函数は，例えば$s_1$として\verb|test|

\verb|_select_pairings_for_v_range|


\verb|compute_hilfsatz4_common_v_bounds|函数によって，
