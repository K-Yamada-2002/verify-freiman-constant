...
これは比較対象の全ての組合せについての条件なので，比較対象が0個の場合は真と判定する．
例えば，ケース群2.6の最初の遷移では，次の\verb|case|の接続条件に下限がなく，比較すべき組合せが存在しない．
この判定だけで被覆全体が成立するわけではなく，各\verb|case|内の条件の両立性，許容性，対象範囲の両端は別途検証する．
\end{itemize}
